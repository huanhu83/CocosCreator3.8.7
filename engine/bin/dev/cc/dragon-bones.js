System.register(['./gc-object-CbS29vYa.js', './_virtual_internal_constants-Cb-eEldT.js', './index-oHSn7cpO.js', './2d.js', './sprite-frame-HkOXrlXI.js', './prefab-CvAWu2P7.js', './scene-B79xt5WD.js', './pipeline-state-manager-C5ShdTPh.js', './node-event-BDQEXkZZ.js', './deprecated-B0llPila.js', './director-CFEaPqP_.js', './debug-view-CfU41ypM.js', './global-exports-C7R_I6Kn.js', './ui-renderer-CrISADqA.js', './deprecated-DMYVurVK.js', './device-manager-gD_whA7Q.js', './buffer-barrier-BmKiPanc.js', './sorting-2d-1FxWtICU.js', './sorting-layers-Bt6H5Neq.js', './deprecated-CIxijlmD.js', './sprite-CxiN4zvk.js', './label-BD4Hb6_e.js', './mask.js', './graphics-BCyLukuH.js', './rich-text.js', './sprite-renderer-B7zyk0fN.js', './camera-component-2LVRWB7s.js', './deprecated-DbHjng6y.js', './model-renderer-CC8iC6el.js', './renderer-2n4MtCXy.js', './touch-iR3Bpatu.js', './create-mesh-C6uBXS6f.js', './mesh-KkRb0lsQ.js', './wasm-web-Dlyu7UW0.js', './zlib.min-CSSqgreA.js'], (function (exports) {
    'use strict';
    var _inheritsLoose, _createClass, warn, EventTarget, _assertThisInitialized, Enum, ccenum, setClassAlias, RecyclePool, setPropertyEnumType, CCObjectFlags, errorID, _createForOfIteratorHelperLoose, _applyDecoratedDescriptor, ccclass$8, Rect, Mat4, Color, Vec3, Scheduler, SystemPriority, applyDecoratedInitializer, serializable$3, type$2, System, override$1, SpriteFrame, Node, Texture2D, MaterialInstance, builtinResMgr, Material, Asset, game, Game, director, cclegacy, RenderDrawInfo, RenderEntity, RenderEntityType, UIRenderer, StaticVBAccessor, RenderData, vfmtPosUvColor, BlendFactor;
    return {
        ...
        execute: (function () {
              ...
              _createClass(CCTextureAtlasData, [{
                ...
                set: function set(value) {
                  ...
                  if (value) {
                    ...
                    for (var _k2 in this.textures) {
                      var _textureData = this.textures[_k2];
            ...
            var CCTextureData = (_dec2$2 = ccclass$7('dragonBones.CCTextureData'), _dec2$2(_class3 = function (_TextureData) {
            ...
            var CCSlot = (_dec$6 = ccclass$6('dragonBones.CCSlot'), _dec$6(_class$6 = function (_Slot) {
              ...
              ;
              _proto.calculWorldMatrix =
              function calculWorldMatrix() {
              ...
              ;
              _proto._onUpdateDisplay =
              function _onUpdateDisplay() {}
              ;
              _proto._initDisplay =
              function _initDisplay(value) {}
              ;
              _proto._addDisplay =
              function _addDisplay() {
                this._visible = true;
              }
              ;
              _proto._replaceDisplay =
              function _replaceDisplay(value) {}
              ;
              _proto._removeDisplay =
              function _removeDisplay() {
                this._visible = false;
              }
              ;
              _proto._disposeDisplay =
              function _disposeDisplay(object) {}
              ;
              _proto._updateVisible =
              function _updateVisible() {
                this._visible = this.parent.visible;
              }
              ;
              _proto._updateGlueMesh =
              function _updateGlueMesh() {}
              ;
              _proto._updateZOrder =
              function _updateZOrder() {}
              ;
              _proto._updateBlendMode =
              ...
              function _updateFrame() {
                ...
                if (currentVerticesData) {
                  ...
                  for (var _i2 = 0; _i2 < triangleCount * 3; ++_i2) {
                    indices[indexOffset++] = intArray[currentVerticesData.offset + BinaryOffset.MeshVertexIndices + _i2];
                  }
              ...
              function _updateMesh() {
                ...
                if (weightData) {
                  ...
                  for (var _i4 = 0, l = _vertexCount, _lvi2 = 0; _i4 < l; _i4++, _lvi2 += 4) {
                    var x = _floatArray[vertexOffset + _i4 * 2] * scale + deformVertices[_i4 * 2];
                    var y = _floatArray[vertexOffset + _i4 * 2 + 1] * scale + deformVertices[_i4 * 2 + 1];
                    if (isSurface) {
                      var _matrix = this._parent._getGlobalTransformMatrix(x, y);
                      localVertices[_lvi2] = _matrix.a * x + _matrix.c * y + _matrix.tx;
                      localVertices[_lvi2 + 1] = -_matrix.b * x + _matrix.d * y + _matrix.ty;
                    } else {
                      localVertices[_lvi2] = x;
                      localVertices[_lvi2 + 1] = -y;
                    }
                  }
                }
                if (weightData) {
              ...
              ;
              _proto._identityTransform =
              function _identityTransform() {
                var m = this._matrix;
                m.m00 = 1.0;
                m.m01 = 0.0;
                m.m04 = -0.0;
            ...
            var CCArmatureDisplay = (_dec$5 = ccclass$5('dragonBones.CCArmatureDisplay'), _dec$5(_class$5 = function (_DisplayData) {
              ...
              ;
              _proto.addEvent =
              function addEvent(type, listener, thisObject) {
                warn('Method not implemented.');
              }
              ;
              _proto.removeEvent =
              function removeEvent(type, listener, thisObject) {
                warn('Method not implemented.');
              }
              ;
              _proto.setEventTarget =
              function setEventTarget(eventTarget) {
                this._eventTarget = eventTarget;
              }
              ;
              _proto.getRootDisplay =
              ...
              ;
              _proto.convertToRootSpace =
              function convertToRootSpace(pos) {
              ...
              ;
              _proto.convertToWorldSpace =
              function convertToWorldSpace(point) {
              ...
              ;
              _proto.advanceTimeBySelf =
              function advanceTimeBySelf(on) {
            ...
            var CCFactory = (_dec$4 = ccclass$4('CCFactory'), _dec$4(_class$4 = (_class2$4 = function (_BaseFactory) {
              _inheritsLoose(CCFactory, _BaseFactory);
              CCFactory.getInstance =
              ...
              ;
              _proto.getDragonBonesDataByRawData =
              function getDragonBonesDataByRawData(rawData) {
              ...
              ;
              _proto.createArmatureNode =
              function createArmatureNode(comp, armatureName, node) {
                node = node || new Node();
              ...
              ;
              _proto.getDragonBonesDataByUUID =
              function getDragonBonesDataByUUID(uuid) {
              ...
              ;
              _proto.removeDragonBonesDataByUUID =
              function removeDragonBonesDataByUUID(uuid, disposeData) {
              ...
              return CCFactory;
            }(BaseFactory), _class2$4._factory = null, _class2$4)) || _class$4);
            ...
            var AnimationCache = function () {
              ...
              _proto.init =
              function init(armatureInfo, animationName) {
                this._inited = true;
              ...
              ;
              _proto._needToUpdate =
              function _needToUpdate(toFrameIdx) {
                var armatureInfo = this._armatureInfo;
                var armature = armatureInfo.armature;
                var animation = armature.animation;
              ...
              ;
              _proto.updateToFrame =
              function updateToFrame(toFrameIdx) {
              ...
              ;
              _proto.invalidAllFrame =
              function invalidAllFrame() {
                this.isCompleted = false;
                this._invalid = true;
              }
              ;
              _proto.updateAllFrame =
              function updateAllFrame() {
                this.invalidAllFrame();
                this.updateToFrame();
              }
              ;
              _proto.enableCacheAttachedInfo =
              function enableCacheAttachedInfo() {
              ...
              function updateFrame(armature, index) {
                ...
                for (var _i2 = 0; _i2 < _indexOffset$1; _i2++) {
                  indices[_i2] = _indices[_i2];
                }
              ...
              ;
              _proto._traverseArmature =
              function _traverseArmature(armature, parentOpacity) {
                ...
                for (var _i4 = 0, _l2 = slots.length; _i4 < _l2; _i4++) {
                  slot = slots[_i4];
            ...
            var ArmatureCache = function () {
              ...
              _proto2.dispose =
              function dispose() {
                for (var _key2 in this._armatureCache) {
                  var armatureInfo = this._armatureCache[_key2];
                  if (armatureInfo) {
                    var armature = armatureInfo.armature;
              ...
              ;
              _proto2._removeArmature =
              function _removeArmature(armatureKey) {
              ...
              ;
              _proto2.resetArmature =
              function resetArmature(uuid) {
              ...
              ;
              _proto2.getArmatureCache =
              function getArmatureCache(armatureName, armatureKey, atlasUUID) {
                var armatureInfo = this._armatureCache[armatureKey];
                var armature;
                if (!armatureInfo) {
              ...
              ;
              _proto2.getAnimationCache =
              function getAnimationCache(armatureKey, animationName) {
                var armatureInfo = this._armatureCache[armatureKey];
              ...
              ;
              _proto2.initAnimationCache =
              function initAnimationCache(armatureKey, animationName) {
              ...
              ;
              _proto2.invalidAnimationCache =
              function invalidAnimationCache(armatureKey) {
                var armatureInfo = this._armatureCache[armatureKey];
                var armature = armatureInfo && armatureInfo.armature;
                if (!armature) return;
                var animationsCache = armatureInfo.animationsCache;
              ...
              ;
              _proto2.updateAnimationCache =
              function updateAnimationCache(armatureKey, animationName) {
                if (animationName) {
              ...
              ;
              ArmatureCache.canCache =
              function canCache(armature) {
                var slots = armature._slots;
                for (var i = 0, l = slots.length; i < l; i++) {
                  var slot = slots[i];
                  if (slot.childArmature) {
            ...
            var DragonBonesAsset = (_dec$3 = ccclass$3('dragonBones.DragonBonesAsset'), _dec$3(_class$3 = (_class2$2 = function (_Asset) {
              ...
              ;
              _proto.getArmatureEnum =
              function getArmatureEnum() {
              ...
              ;
              _proto.getAnimsEnum =
              function getAnimsEnum(armatureName) {
                this.init();
                var dragonBonesData = this._factory.getDragonBonesDataByUUID(this._uuid);
                if (dragonBonesData) {
            ...
            var AttachUtil = (_dec$1 = ccclass$1('dragonBones.AttachUtil'), _dec$1(_class$1 = function () {
              ...
              ;
              _proto._syncAttachedNode =
              function _syncAttachedNode() {
                if (!this._inited) return;
            ...
            var ArmatureDisplay = (_dec3 = ccclass('dragonBones.ArmatureDisplay'), _dec4 = type(DragonBonesAsset), _dec5 = type(DragonBonesAtlasAsset), _dec6 = type(DefaultArmaturesEnum), _dec7 = type(DefaultAnimsEnum), _dec8 = type([DragonBoneSocket]), _dec9 = type(Material), _dec3(_class4 = (_class5 = (_class6 = function (_UIRenderer) {
              ...
              ;
              _proto._requestDrawData =
              function _requestDrawData(material, texture, indexOffset, indexCount) {
              ...
              ;
              _proto.getMaterialForBlend =
              function getMaterialForBlend(src, dst) {
                var key = src + "/" + dst;
              ...
              ;
              _proto.getArmatureKey =
              function getArmatureKey() {
              ...
              ;
              _proto._emitCacheCompleteEvent =
              function _emitCacheCompleteEvent() {
              ...
              ;
              _proto._updateDebugDraw =
              function _updateDebugDraw() {
                if (this.debugBones) {
                  if (!this._debugDraw) {
              ...
              ;
              _proto._buildArmature =
              function _buildArmature() {
              ...
              function querySocketPathByName(name) {
                var ret = [];
              ...
              ;
              _proto._parseDragonAtlasAsset =
              function _parseDragonAtlasAsset() {
              ...
              _proto._updateCacheModeEnum =
              function _updateCacheModeEnum() {
              ...
              ;
              _proto._updateArmatureEnum =
              function _updateArmatureEnum() {
                var armatureEnum;
                if (this.dragonAsset) {
              ...
              ;
              _proto._indexBoneSockets =
              function _indexBoneSockets() {
                if (!this._armature) {
                  return;
                }
                ...
                var walkArmature = function walkArmature(prefix, armature) {
                  ...
                  for (var _i2 = 0; _i2 < bones.length; _i2++) {
                    cacheBoneName(_i2, bones, boneToName);
                  }
                  ...
                  for (var _i4 = 0; _i4 < slots.length; _i4++) {
                    if (slots[_i4].childArmature) {
                      walkArmature(slots[_i4].name, slots[_i4].childArmature);
                    }
                  }
                };
              ...
              ;
              _proto.playAnimation =
              function playAnimation(animName, playTimes) {
              ...
              ;
              _proto.updateAnimationCache =
              function updateAnimationCache(animName) {
                if (!this.isAnimationCached()) return;
              ...
              ;
              _proto.getArmatureNames =
              function getArmatureNames() {
              ...
              ;
              _proto.getAnimationNames =
              function getAnimationNames(armatureName) {
                var ret = [];
                var dragonBonesData = this._factory.getDragonBonesData(this._armatureKey);
                if (dragonBonesData) {
              ...
              ;
              _proto.on =
              function on(eventType, listener, target) {
                this.addEventListener(eventType, listener, target);
              }
              ;
              _proto.off =
              function off(eventType, listener, target) {
                this.removeEventListener(eventType, listener, target);
              }
              ;
              _proto.once =
              function once(eventType, listener, target) {
              ...
              ;
              _proto.removeEventListener =
              function removeEventListener(eventType, listener, target) {
                this._eventTarget.off(eventType, listener, target);
              }
              ;
              _proto.buildArmature =
              function buildArmature(armatureName, node) {
            ...
            function realTimeTraverse(armature, parentOpacity, worldMat) {
              ...
              for (var i = 0, l = slots.length; i < l; i++) {
                ...
                if (isResize) {
                  ...
                  for (var _i2 = 0; _i2 < _indexOffset; ++_i2) {
                    _ibuf[_i2] = oldIndices[_i2] + correction;
                  }
                }
                ...
                for (var _i4 = 0, il = indices.length, ii = _indexOffset; _i4 < il; _i4++, ii++) {
                  _ibuf[ii] = _vertexOffset + indices[_i4] + chunkOffset;
                }
            ...
            function cacheTraverse(frame, parentMat) {
              ...
              for (var i = 0, n = segments.length; i < n; i++) {
                ...
                var offset = 0;
                if (parentMat) {
                  for (var _ii2 = 0, _il2 = _vertexCount; _ii2 < _il2; _ii2++) {
                ...
                if (_handleVal & NEED_COLOR) {
                  ...
                  for (var _ii4 = frameVFOffset, iEnd = frameVFOffset + segVFCount; _ii4 < iEnd; _ii4 += PER_VERTEX_SIZE, frameColorOffset += 5) {
