System.register(['./gc-object-CbS29vYa.js', './index-oHSn7cpO.js', './_virtual_internal_constants-Cb-eEldT.js', './global-exports-C7R_I6Kn.js', './scene-B79xt5WD.js', './node-event-BDQEXkZZ.js', './deprecated-DMYVurVK.js', './ui-renderer-CrISADqA.js', './director-CFEaPqP_.js', './debug-view-CfU41ypM.js', './device-manager-gD_whA7Q.js', './buffer-barrier-BmKiPanc.js', './deprecated-CIxijlmD.js'], (function (exports) {
    'use strict';
    var ccenum, _inheritsLoose, warnID, _createClass, _applyDecoratedDescriptor, _assertThisInitialized, Vec2, Color, ccclass, type, override, applyDecoratedInitializer, executionOrder, serializable, cclegacy, builtinResMgr, Model, MeshRenderData, vfmtPosColor, getComponentPerVertex, getAttributeStride, RenderEntity, RenderEntityType, UIRenderer, InstanceMaterialType, director, RenderingSubMesh, deviceManager, Attribute, Format, BufferInfo, BufferUsageBit, MemoryUsageBit, PrimitiveMode;
    return {
        ...
        execute: (function () {
            ...
            })(PointFlags || (exports("b", PointFlags = {})));
            ccenum(PointFlags);
            ...
            var _dec, _dec2, _dec3, _dec4, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _class3;
            ...
            var Graphics = exports("G", (_dec = ccclass("cc.Graphics"), _dec2 = executionOrder(110), _dec3 = type(LineJoin), _dec4 = type(LineCap), _dec(_class = _dec2(_class = (_class2 = (_class3 = function (_UIRenderer) {
              ...
              ;
              _proto.bezierCurveTo =
              function bezierCurveTo(c1x, c1y, c2x, c2y, x, y) {
                if (!this.impl) {
                  return;
                }
              ...
              ;
              _proto.arc =
              function arc(cx, cy, r, startAngle, endAngle, counterclockwise) {
                if (!this.impl) {
                  return;
                }
              ...
              ;
              _proto.activeSubModel =
              function activeSubModel(idx) {
                if (!this.model) {
              ...
              return Graphics;
            }(UIRenderer), _class3.LineJoin = LineJoin, _class3.LineCap = LineCap, _class3), (_applyDecoratedDescriptor(_class2.prototype, "lineJoin", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "lineJoin"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "lineCap", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "lineCap"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "color", [override], Object.getOwnPropertyDescriptor(_class2.prototype, "color"), _class2.prototype), _initializer = applyDecoratedInitializer(_class2.prototype, "_lineWidth", [serializable], function () {
              return 1;
