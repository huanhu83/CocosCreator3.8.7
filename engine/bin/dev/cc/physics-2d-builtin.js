System.register(['./physics-2d-framework-CrIt27Tr.js', './gc-object-CbS29vYa.js', './_virtual_internal_constants-Cb-eEldT.js', './index-oHSn7cpO.js', './intersection-2d.js', './prefab-CvAWu2P7.js', './scene-B79xt5WD.js', './pipeline-state-manager-C5ShdTPh.js', './node-event-BDQEXkZZ.js', './deprecated-B0llPila.js', './director-CFEaPqP_.js', './collision-matrix-ZbGqiKNy.js', './global-exports-C7R_I6Kn.js', './touch-iR3Bpatu.js', './device-manager-gD_whA7Q.js', './buffer-barrier-BmKiPanc.js', './debug-view-CfU41ypM.js', './deprecated-DMYVurVK.js'], (function () {
    'use strict';
    var PhysicsSystem2D, Contact2DType, EPhysics2DDrawFlags, selector, _createClass, _inheritsLoose, error, fastRemoveAt, CCObjectFlags, errorID, Rect, Vec2, Mat4, Color, Vec3, Intersection2D, find, Node, game, Game, director;
    return {
        ...
        execute: (function () {
            ...
            var BuiltinPhysicsWorld = function () {
              ...
              _proto.step = function step(deltaTime, velocityIterations, positionIterations) {
                ...
                for (var _i2 = 0, _l2 = contacts.length; _i2 < _l2; _i2++) {
                  var collisionType = contacts[_i2].updateState();
                  if (collisionType === Contact2DType.None) {
                    continue;
                  }
                  contactResults.push(contacts[_i2]);
                }
                for (var _i4 = 0, _l4 = contactResults.length; _i4 < _l4; _i4++) {
                  var result = contactResults[_i4];
