System.register(['./index-CjNBLuX-.js', './gc-object-CbS29vYa.js', './index-oHSn7cpO.js', './collision-matrix-ZbGqiKNy.js', './array-collision-matrix-DKI57SKj.js', './physics-framework.js', './deprecated-B0llPila.js', './director-CFEaPqP_.js', './util-Br_fQTr5.js', './_virtual_internal_constants-Cb-eEldT.js', './global-exports-C7R_I6Kn.js', './node-event-BDQEXkZZ.js', './scene-B79xt5WD.js', './pipeline-state-manager-C5ShdTPh.js', './device-manager-gD_whA7Q.js', './buffer-barrier-BmKiPanc.js', './touch-iR3Bpatu.js', './deprecated-DMYVurVK.js', './debug-view-CfU41ypM.js', './prefab-CvAWu2P7.js', './mesh-KkRb0lsQ.js', './wasm-web-Dlyu7UW0.js', './zlib.min-CSSqgreA.js', './skeleton-YQW3avZy.js', './terrain-asset-BFP_6GVw.js', './base.js', './deprecated-CIxijlmD.js', './render-types-CckVe7el.js', './deprecated-DbHjng6y.js', './camera-component-2LVRWB7s.js', './model-renderer-CC8iC6el.js', './renderer-2n4MtCXy.js', './instantiate-CDXpXX6j.js', './move-DVEb9A_n.js', './capsule-BfNU2Izo.js'], (function (exports) {
    'use strict';
    var PhysicsSystem, selector, _inheritsLoose, fastRemoveAt, _createClass, warnID, error, Mat4, Vec3, Quat, intersect, AABB, Color, OBB, Sphere, Capsule, PhysicsGroup, EPhysicsDrawFlags, EAxisDirection, ArrayCollisionMatrix, game, Game, director, maxComponent;
    return {
        setters: [function (module) {
            PhysicsSystem = module.P;
            selector = module.s;
            exports("CharacterControllerContact", module.q);
        }, function (module) {
            ...
            var BuiltInWorld = function () {
              ...
              _proto.raycast = function raycast(worldRay, options, pool, results) {
                ...
                for (var i = 0; i < this.bodies.length; i++) {
                  var body = this.bodies[i];
                  if (!(body.collisionFilterGroup & mask)) continue;
                  for (var _i4 = 0; _i4 < body.shapes.length; _i4++) {
                    var shape = body.shapes[_i4];
                    var distance = intersect.resolve(worldRay, shape.worldShape);
                    if (distance === 0 || distance > max_d) {
                      continue;
                    } else {
              ...
              _proto.emitTriggerEvent = function emitTriggerEvent() {
                ...
                for (var _i6 = 0; _i6 < this._shapeArrPrev.length; _i6 += 2) {
                  shapeA = this._shapeArrPrev[_i6];
                  shapeB = this._shapeArrPrev[_i6 + 1];
                  if (this._collisionMatrixPrev.get(shapeA.id, shapeB.id)) {
