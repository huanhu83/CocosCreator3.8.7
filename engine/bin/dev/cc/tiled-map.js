System.register(['./gc-object-CbS29vYa.js', './index-oHSn7cpO.js', './_virtual_internal_constants-Cb-eEldT.js', './global-exports-C7R_I6Kn.js', './node-event-BDQEXkZZ.js', './sprite-renderer-B7zyk0fN.js', './ui-renderer-CrISADqA.js', './label-BD4Hb6_e.js', './ZipUtils-vgdfHea5.js', './zlib.min-CSSqgreA.js', './scene-B79xt5WD.js', './prefab-CvAWu2P7.js', './pipeline-state-manager-C5ShdTPh.js', './deprecated-B0llPila.js', './director-CFEaPqP_.js', './sprite-CxiN4zvk.js', './device-manager-gD_whA7Q.js', './buffer-barrier-BmKiPanc.js', './sprite-frame-HkOXrlXI.js', './debug-view-CfU41ypM.js', './camera-component-2LVRWB7s.js', './deprecated-DMYVurVK.js', './deprecated-DbHjng6y.js', './model-renderer-CC8iC6el.js', './renderer-2n4MtCXy.js', './sorting-layers-Bt6H5Neq.js', './touch-iR3Bpatu.js', './create-mesh-C6uBXS6f.js', './mesh-KkRb0lsQ.js', './wasm-web-Dlyu7UW0.js'], (function (exports) {
    'use strict';
    var ccenum, logID, error, errorID, warn, _createClass, _inheritsLoose, _applyDecoratedDescriptor, CCInteger, warnID, CCObjectFlags, CCBoolean, CCString, _createForOfIteratorHelperLoose, Vec2, Color, Size, Rect, ccclass, type, applyDecoratedInitializer, requireComponent, Mat4, Vec3, screenAdapter, serializable, sys, EDITOR, NodeEventType, Component, Asset, UITransform, RenderDrawInfo, RenderDrawInfoType, RenderData, RenderEntity, RenderEntityType, UIRenderer, StaticVBAccessor, vfmtPosUvColor, Label, codec, _p, SAXParser, Node, TextAsset, View, director, Sprite, BlendFactor, SpriteFrame;
    return {
        ...
        execute: (function () {
            ...
            var TMXObjectGroupInfo = function () {
              ...
              _proto2.getProperties =
              function getProperties() {
                return this.properties;
              }
              ;
              _proto2.setProperties =
            ...
            var TMXMapInfo = function () {
              ...
              ;
              _proto.getStaggerAxis =
              function getStaggerAxis() {
                return this._staggerAxis;
              }
              ;
              _proto.setStaggerAxis =
              function setStaggerAxis(value) {
                this._staggerAxis = value;
              }
              ;
              _proto.getStaggerIndex =
              function getStaggerIndex() {
                return this._staggerIndex;
              }
              ;
              _proto.setStaggerIndex =
              function setStaggerIndex(value) {
                this._staggerIndex = value;
              }
              ;
              _proto.getHexSideLength =
              function getHexSideLength() {
                return this._hexSideLength;
              }
              ;
              _proto.setHexSideLength =
              function setHexSideLength(value) {
              ...
              ;
              _proto.setLayers =
              function setLayers(value) {
                this._allChildren.push(value);
                this._layers.push(value);
              }
              ;
              _proto.getImageLayers =
              function getImageLayers() {
                return this._imageLayers;
              }
              ;
              _proto.setImageLayers =
              function setImageLayers(value) {
                this._allChildren.push(value);
              ...
              function setObjectGroups(value) {
                this._allChildren.push(value);
              ...
              ;
              _proto.getParentElement =
              function getParentElement() {
                return this.parentElement;
              }
              ;
              _proto.setParentElement =
              function setParentElement(value) {
              ...
              ;
              _proto.setParentGID =
              function setParentGID(value) {
                this.parentGID = value;
              }
              ;
              _proto.getLayerAttribs =
              function getLayerAttribs() {
                return this.layerAttrs;
              }
              ;
              _proto.setLayerAttribs =
              function setLayerAttribs(value) {
                this.layerAttrs = value;
              }
              ;
              _proto.getStoringCharacters =
              function getStoringCharacters() {
                return this.storingCharacters;
              }
              ;
              _proto.setStoringCharacters =
              function setStoringCharacters(value) {
              ...
              ;
              _proto.initWithXML =
              function initWithXML(tmxString, tsxMap, spfTextureMap, textureSizes, imageLayerTextures) {
              ...
              ;
              _proto.parseXMLString =
              function parseXMLString(xmlStr, tilesetFirstGid) {
            ...
            var TiledTile = exports("TiledTile", (_dec$4 = ccclass('cc.TiledTile'), _dec2$4 = requireComponent(UITransform), _dec3$3 = type(CCInteger), _dec4$1 = type(CCInteger), _dec5$1 = type(CCInteger), _dec6$1 = type(CCInteger), _dec7$1 = type(CCInteger), _dec$4(_class$4 = _dec2$4(_class$4 = (_class2$3 = function (_Component) {
              ...
              return TiledTile;
            }(Component), (_initializer$2 = applyDecoratedInitializer(_class2$3.prototype, "_x", [_dec3$3], function () {
              return 0;
            ...
            var TiledUserNodeData = exports("TiledUserNodeData", (_dec$3 = ccclass('cc.TiledUserNodeData'), _dec$3(_class$3 = function (_Component) {
            ...
            var TiledLayer = exports("TiledLayer", (_dec2$3 = ccclass('cc.TiledLayer'), _dec2$3(_class3$1 = function (_UIRenderer) {
              ...
              ;
              _proto.removeUserNode =
              function removeUserNode(node) {
                var dataComp = node.getComponent(TiledUserNodeData);
                if (!dataComp) {
                  warnID(7243);
                  return false;
              ...
              ;
              _proto.destroyUserNode =
              function destroyUserNode(node) {
                this.removeUserNode(node);
                node.destroy();
              }
              ;
              _proto._nodeLocalPosToLayerPos =
              function _nodeLocalPosToLayerPos(nodePos, out) {
              ...
              ;
              _proto.getPositionAt =
              function getPositionAt(pos, y) {
                var x;
                if (y !== undefined) {
                  x = Math.floor(pos);
                  y = Math.floor(y);
              ...
              ;
              _proto.setTilesGIDAt =
              function setTilesGIDAt(gids, beginCol, beginRow, totalCols) {
              ...
              ;
              _proto.setTileGIDAt =
              function setTileGIDAt(gid, x, y, flags) {
              ...
              ;
              _proto.getTileFlagsAt =
              function getTileFlagsAt(x, y) {
                if (this.isInvalidPosition(x, y)) {
              ...
              ;
              _proto.updateViewPort =
              function updateViewPort(x, y, width, height) {
              ...
              ;
              _proto._positionToRowCol =
              function _positionToRowCol(x, y, result) {
              ...
              ;
              _proto.getTiledTileAt =
              function getTiledTileAt(x, y, forceCreate) {
                if (this.isInvalidPosition(x, y)) {
              ...
              ;
              _proto.setTiledTileAt =
              function setTiledTileAt(x, y, tiledTile) {
                if (this.isInvalidPosition(x, y)) {
              ...
              function setTileSets(tilesets) {
                ...
                for (var _i2 = 0, l = tilesets.length; _i2 < l; ++_i2) {
                  var tilesetInfo = tilesets[_i2];
              ...
              return TiledLayer;
            }(UIRenderer)) || _class3$1));

            var _dec$2, _dec2$2, _dec3$2, _class$2, _class2$2;
            var TiledObjectGroup = exports("TiledObjectGroup", (_dec$2 = ccclass('cc.TiledObjectGroup'), _dec2$2 = requireComponent(UITransform), _dec3$2 = type(CCBoolean), _dec$2(_class$2 = _dec2$2(_class$2 = (_class2$2 = function (_Component) {
              ...
              _proto._init =
              function _init(groupInfo, mapInfo, texGrids) {
                var FLIPPED_MASK = TileFlag.FLIPPED_MASK;
                ...
                for (var _i2 = 0, n = children.length; _i2 < n; _i2++) {
            ...
            var TiledMapAsset = exports("TiledMapAsset", (_dec$1 = ccclass('cc.TiledMapAsset'), _dec2$1 = type([TextAsset]), _dec3$1 = type([CCString]), _dec4 = type([SpriteFrame]), _dec5 = type([SpriteFrame]), _dec6 = type([CCString]), _dec7 = type([CCString]), _dec8 = type([Size]), _dec$1(_class$1 = (_class2$1 = function (_Asset) {
            ...
            var TiledMap = exports("TiledMap", (_dec = ccclass('cc.TiledMap'), _dec2 = requireComponent(UITransform), _dec3 = type(TiledMapAsset), _dec(_class = _dec2(_class = (_class2 = (_class3 = function (_Component) {
              ...
              ;
              _proto.getObjectGroup =
              function getObjectGroup(groupName) {
              ...
              ;
              _proto.getPropertiesForGID =
              function getPropertiesForGID(gid) {
                return this._tileProperties.get(gid);
              }
              ;
              _proto.enableTexelOffset =
              function enableTexelOffset(enable) {
              ...
              _proto._applyFile = function _applyFile() {
                ...
                if (file) {
                  ...
                  for (var _i2 = 0; _i2 < texValues.length; ++_i2) {
                    imageLayerTextures[spfNames[_i2]] = texValues[_i2];
                  }
                  var tsxFileNames = file.tsxFileNames;
                  var tsxFiles = file.tsxFiles;
                  var tsxContentMap = {};
                  for (var _i4 = 0; _i4 < tsxFileNames.length; ++_i4) {
                    if (tsxFileNames[_i4].length > 0) {
                      tsxContentMap[tsxFileNames[_i4]] = tsxFiles[_i4].text;
                    }
                  }
              ...
              _proto._releaseMapInfo = function _releaseMapInfo() {
                ...
                layers.length = 0;
                var groups = this._groups;
                for (var _i6 = 0, _l2 = groups.length; _i6 < _l2; _i6++) {
                  groups[_i6].node.removeFromParent();
                  groups[_i6].node.destroy();
                }
                groups.length = 0;
                var images = this._images;
                for (var _i8 = 0, _l4 = images.length; _i8 < _l4; _i8++) {
                  images[_i8].removeFromParent();
                  images[_i8].destroy();
                }
                images.length = 0;
              };
              ...
              _proto._buildLayerAndGroup = function _buildLayerAndGroup() {
                ...
                var images = this._images;
                var oldNodeNames = {};
                for (var _i10 = 0, n = layers.length; _i10 < n; _i10++) {
                  oldNodeNames[layers[_i10].node.name] = true;
                }
                for (var _i12 = 0, _n2 = groups.length; _i12 < _n2; _i12++) {
                  oldNodeNames[groups[_i12].node.name] = true;
                }
                for (var _i14 = 0, _n4 = images.length; _i14 < _n4; _i14++) {
                  oldNodeNames[images[_i14].name] = true;
                }
                layers = this._layers = [];
                groups = this._groups = [];
                images = this._images = [];
                ...
                if (layerInfos && layerInfos.length > 0) {
                  for (var _i16 = 0, len = layerInfos.length; _i16 < len; _i16++) {
                    var layerInfo = layerInfos[_i16];
                ...
                for (var _i18 = 0, _n6 = children.length; _i18 < _n6; _i18++) {
                  var c = children[_i18];
              ...
              _proto._buildWithMapInfo = function _buildWithMapInfo(mapInfo) {
                ...
                for (var _i20 = 0; _i20 < this._imageLayers.length; _i20++) {
                  var imageLayer = this._imageLayers[_i20];
            ...
            var Simple = function () {
              ...
              _proto.fillBuffers = function fillBuffers(layer, renderer) {
                ...
                var vertexId = renderData.chunk.vertexOffset;
                var quadCount = renderData.vertexCount / 4;
                for (var _i2 = 0; _i2 < quadCount; _i2 += 1) {
                  iBuf[indexOffset] = vertexId;
                  iBuf[indexOffset + 1] = vertexId + 1;
                  iBuf[indexOffset + 2] = vertexId + 2;
                  iBuf[indexOffset + 3] = vertexId + 2;
              ...
              _proto.updateColor = function updateColor(tiled) {
                ...
                for (var index = 0; index < rs.length; index++) {
                  ...
                  for (var _i4 = renderData.vertexStart, l = renderData.vertexCount; _i4 < l; _i4++) {
                    vs.set(colorV, _i4 * 9 + 5);
                  }
                }
              };
              return Simple;
